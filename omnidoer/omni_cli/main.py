...
def build_parser() -> argparse.ArgumentParser:
    ...
    pair_top.add_argument("--expires", default="24h")
    ...
    serve.add_argument("--vault-passphrase-env")
    serve.add_argument("--vault-passphrase-file")
    ...
    pair.add_argument("--expires", default="24h")
    ...
    enable_sync = control_sub.add_parser("enable-sync")
    ...
    heartbeat_add_task.add_argument("--priority", default="")
    heartbeat_add_task.add_argument("--quota", default="")
    heartbeat_add_task.add_argument("--repo-path", default="")
    heartbeat_add_task.add_argument("--remote-url", default="")
    heartbeat_add_task.add_argument("--target", default="")
    heartbeat_add_task.add_argument("--deadline-utc", default="")
    heartbeat_add_task.add_argument("--min-interval")
    heartbeat_add_task.add_argument("--no-interrupt-active", action="store_true")

...
# Match Codex TUI's MAX_USER_INPUT_TEXT_CHARS so Control Client submissions
# are not rejected before the active console can accept them.
MAX_CHAT_TEXT_LENGTH = 1 << 20

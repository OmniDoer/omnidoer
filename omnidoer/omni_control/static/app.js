const I18N = {
  en: {
    ...
    runtimeWaitingForConsoleRestart: "The Control Service is waiting for the current CLI session to attach.",
    ...
    chatSessionServerOnlyDetail: "This browser is authenticated, but the current CLI session is not attached to this phone yet. Resume the same conversation or enable session sync before sending.",
    ...
    sendUnavailable: "Session not attached",
    ...
    slashCommandModelDesc: "Explain mobile model switching status.",
  ...
  zh: {
    ...
    runtimeWaitingForConsoleRestart: "Control Service 正在等待当前 CLI 会话接入。",
    ...
    chatSessionServerOnlyDetail: "此浏览器已认证，但当前 CLI 会话还没接入手机端。请恢复同一段对话或启用会话同步后再发送。",
    ...
    slashCommandModelDesc: "说明移动端模型切换状态。",
